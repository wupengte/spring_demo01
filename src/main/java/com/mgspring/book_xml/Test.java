package com.mgspring.book_xml;

import com.mgspring.book_xml.controller.BookController;
...
public class Test {
    ...
    public static void main(String[] args) {
        ApplicationContext cap = new ClassPathXmlApplicationContext("META-INF/book_xml.xml");
